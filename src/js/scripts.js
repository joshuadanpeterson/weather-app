  ...
  // Accesing Geolocation of User
    if (navigator.geolocation) {
        ...
        fetch(base)
            ...
            //This is for bacground image lookup & DOM update
            const imageFile = imagelist[description];
            document.getElementById('a').style.backgroundImage="/media/imgs/raining.jpg"; 
